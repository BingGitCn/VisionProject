...
{
    public class Dialog_ModelSetViewModel : BindableBase, IDialogAware //, IFunction_ViewModel_Interface
    {
        private IDialogService _dialogService;

        public Dialog_ModelSetViewModel(IDialogService dialogService)
        {
