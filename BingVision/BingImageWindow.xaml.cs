...
namespace BingLibrary.Vision
{
    ...
    public partial class BingImageWindow : UserControl
    {
        ...
        private void iwin_HInitWindow(object sender, EventArgs e)
        {
            ...
            windowData.HCtrl.setViewState(HWndCtrl.MODE_VIEW_MOVE);
            ...
            windowData.HCtrl.ShowWaterString = config.IsShowWaterString;
            windowData.HCtrl.DrawMode =config.IsShowMargin ? "margin" : "fill";
            windowData.HCtrl.ShowHat = config.IsShowHat;
            windowData.HCtrl.isEdit = config.IsEdit;
        ...
        {
            try { windowData.HCtrl.fitWindow(); windowData.Repaint(); } catch { }
        }
        ...
        {
            windowData.HCtrl.ShowWaterString = (sender as MenuItem).IsChecked;
            windowData.Repaint();
        }
        ...
        {
            windowData.HCtrl.ShowHat = (sender as MenuItem).IsChecked;
            windowData.Repaint();
        }
        ...
        {
            windowData.HCtrl.ShowWaterString = (sender as CheckBox).IsChecked == true;
            windowData.Repaint();
            config.IsShowWaterString = windowData.HCtrl.ShowWaterString;
        ...
        {
            windowData.HCtrl.ShowHat = (sender as CheckBox).IsChecked==true;
            windowData.Repaint();
            config.IsShowMargin = windowData.HCtrl.ShowHat;
            Serialize.WriteJson(config, System.AppDomain.CurrentDomain.BaseDirectory + this.Name + ".Config");
        }
        ...
        private void Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            ROIRectangle1 rr = new ROIRectangle1();
            double r1, c1, r2, c2;
            windowData.hWindow.DrawRectangle1(out r1,out c1,out  r2,out c2);
            rr.createROIRect1(r1, c1,r2,c2);
            rr.draw(iwin.HalconWindow);
            rr.ROIName = getRoiName();
            windowData.RCtrl.ROIList.Add(rr);
        ...
        {
            windowData.HCtrl.isEdit = (sender as CheckBox).IsChecked == true;
            windowData.Repaint();
    ...
    public class Config {
        public bool IsShowHat { set; get; } = false;
