...
namespace BingLibrary.Vision
{
    ...
    public partial class BingImageWindow : UserControl
    {
        ...
        private void iwin_HInitWindow(object sender, EventArgs e)
        {
            ...
            windowData.WindowCtrl.DrawMode = config.IsShowMargin ? HalconDrawing.margin : HalconDrawing.fill;
        ...
        {
            windowData.WindowCtrl.DrawMode = (sender as MenuItem).IsChecked == true ? HalconDrawing.margin : HalconDrawing.fill;
            windowData.WindowCtrl.Repaint();
        }
        ...
        {
            windowData.WindowCtrl.DrawMode = (sender as CheckBox).IsChecked == true ? HalconDrawing.margin : HalconDrawing.fill;
            windowData.WindowCtrl.Repaint();
