...
namespace BingLibrary.Vision
{
    ...
    public class DispObjectController
    {
        ...
        public void AddDispObjectVar(HObject showObject, HalconColors color = HalconColors.绿色)
        {
            DispObjectList.Add(new DispObjectBase(showObject, color));
        }

        /// <summary>
        /// 清空信息
        /// </summary>
        public void ClearDispObjects()
        {
