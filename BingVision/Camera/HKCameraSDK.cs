...
namespace BingLibrary.Vision
{
    ...
    public class MyCamera
    {
        ...
        #endregion 不建议使用的接口 Interfaces not recommended
        ...
        #endregion 弃用的接口（存在更优化的接口可替换）Abandoned interface
        ...
        #endregion 相机参数获取和设置，此模块的所有接口已废弃，建议使用上面的万能接口代替
